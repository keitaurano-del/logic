...
| FB-05 | コース横断/戻る/離脱復帰のナビ・IA再設計【クラスタ4件】 | P1 | IN_PROGRESS（Stage①戻るルール統一 DONE commit `36a2321`。Stage②離脱復帰 DONE 2026-06-02 commit `7b1ca72`/`298c8a6` deploy済＝PERSISTABLE_SCREENS+NAV_SNAPSHOT_KEY+navigate時スナップショット保存+getInitialScreen復元+logic-last-tab。tsc0/eslint0/vitest582pass。残：③完了後CTA） | dev-logic | 2026-06-02 |
