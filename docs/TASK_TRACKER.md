...
| FB-39 | Play Store の掲載情報に載っている Keita の個人情報を非表示にする | P0 | TODO（2026-06-04 Keita「個人情報が載ってるから非表示にしたい」。Play Console → ストアの設定 → 連絡先 で対応） | Keita（Play Console 操作）+ 林（手順案内） | セキュリティ・プライバシー |
