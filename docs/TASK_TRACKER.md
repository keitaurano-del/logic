...
| DF-3 | Phase 3 代表6体フル UI 走行 | P1 | IN_PROGRESS（DF-2b 投入20体の email エリアス形式確認中・本番マジックリンク受信実装予定） | 林 | ログイン方式確定＝実メール（Gmail エイリアス keita.urano+pXX@gmail.com）で本番マジックリンク実受信・走行開始 |
