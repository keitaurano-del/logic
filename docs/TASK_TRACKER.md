...
| FB-05 | コース横断/戻る/離脱復帰のナビ・IA再設計【クラスタ4件】 | P1 | IN_PROGRESS（Stage①戻るルール統一 DONE 2026-06-02 commit `36a2321` deploy済。破綻D：home→roadmap時のタブ同期修正。破綻B/E：returnScreen伝播でsaved-items/journal/wrong-answersからのレッスン完了後に呼び出し元へ戻る。回帰テスト10ケース。tsc0/eslint0/vitest574pass。残：②離脱復帰③完了後CTA） | dev-logic | 2026-06-02 |
