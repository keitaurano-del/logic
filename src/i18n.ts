...
const STRINGS: Record<Locale, Strings> = {
  ja: {
    ...
    'fermi.placeholder': '🎤 音声入力推奨！話しながら分解するとスラスラ出てくるよ。\n\n式でも箇条書きでもOK。\n例: 対象となる人・場所・頻度を順番に考えてみる',
  ...
  en: {
    ...
    'fermi.placeholder': '🎤 Voice input recommended! Try speaking your breakdown aloud.\n\nFormulas or bullet points are both fine.\nTip: think about who, where, and how often.',
