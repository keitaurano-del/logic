...
const fermiLesson226: LessonData = {
  ...
  steps: [
    ...
    },
    {
      ...
      modelAnswer: 'Answer: ~10M litres/day\n\n### Base\n- World population: 8B\n\n### Per person per day\n- Basal tears (blink lubrication): 1 ml/day (constant lacrimal secretion)\n- Emotional tears: crying frequency 2/month (joy + sorrow) × 2 ml = 4 ml/month ≈ 0.13 ml/day\n- Onion / yawn tears: 1/week × 1 ml = 0.14 ml/day\n- Total: ~1.3 ml/person/day\n\n### Global total\n```\n8B × 1.3 ml = 10.4B ml = ~10M litres/day\n```\n\nConversion:\n- 10M litres ≈ 29 standard 25m pools/day (one 25m pool ≈ 360,000 litres)\n- Annual: 10M × 365 ≈ 3.8B litres = ~11,000 pools\n\nAbout the answer:\nNo measured value exists for the world\'s tear volume, and the result shifts greatly depending on how you count tear types (whether basal tears are included). Even so, we do not stop at "there is no answer" — under the premises above, about 10M litres/day is a reasonable target, and that is this problem\'s answer. The goal is segmenting an unmeasurable quantity and landing the right order of magnitude.\n\nTakeaway:\n- Even "tears" — unmeasurable in normal terms — yield to (basal / emotional / physical-stimulus) segmentation\n- Realising basal tears (1-2 ml/day) dominate is the insight\n- Translating into "pool-equivalents" makes the magnitude land',
      points: [
