...
const staminaLesson442: LessonData = {
  ...
  steps: [
    ...
    },
    {
      ...
      visualProps: {
        sectionLabel: '消耗と回復のサイクル — 休むから働ける',
        revealMode: 'static',
        steps: [
          { num: 1, label: '集中して働く', en: 'Focus' },
          { num: 2, label: 'エネルギーが減る', en: 'Deplete' },
          { num: 3, label: '戦略的に休む', en: 'Rest' },
          { num: 4, label: 'エネルギーが戻る', en: 'Recover' },
        ],
        center: { label: 'Effort & Recovery', title: '消耗と回復' },
        hint: '回復を先回りで仕込むほどサイクルは速く回り、夕方まで質が保てます',
      },
      outro:
  ...
  steps: [
    ...
    },
    {
      ...
      visualProps: {
        ...
        hint: '回復するかは活動の種類より、仕事から頭が離れているか、自分で選んでいるかで決まります',
      },
      outro:
