...
export const CANONICAL_TAGS: CanonicalTag[] = [
  ...
  },
  {
    ...
    ja: '学習',
    en: 'study',
    synonyms: ['勉強', '学び', '自己研鑽', 'インプット', 'learning', '読書', '読書時間', 'reading', '資格勉強', '語学'],
  },
  {
    id: 'health',
    axis: 'theme',
  ...
  },
  {
    ...
    ja: 'キャリア',
    en: 'career',
    synonyms: ['進路', '転職', '昇進', '将来設計', 'キャリアプラン', '評価', 'promotion'],
  },
  {
    id: 'self-growth',
    axis: 'theme',
  ...
  },
  {
    ...
    ja: '運動',
    en: 'exercise',
    synonyms: ['筋トレ', 'トレーニング', 'ジム', 'ランニング', '散歩', 'ウォーキング', 'ヨガ', 'workout', 'running', 'walk', 'スポーツ'],
  },
  {
    id: 'rest',
    axis: 'action',
  ...
  },
  {
    ...
    ja: '成果',
    en: 'achievement',
    synonyms: ['達成', '成功', '前進', '進捗', 'うまくいった', '手応え', '完了', 'win', 'progress', 'やりきった'],
  },
  {
    id: 'decision',
    axis: 'situation',
