...
const CHARACTERS: Record<string, CharacterConfig> = {
  ...
  'why-so-report': {
    ...
    imageUrl: '/images/v3/roleplay-char-why-so-report.png',
  ...
  'mece-meeting': {
    ...
    imageUrl: '/images/v3/roleplay-char-mece-meeting.png',
    cameraPosition: [0, 1.45, 2.5],
    cameraTarget: [0, 1.25, 0],
  ...
  'pyramid-client': {
    ...
    imageUrl: '/images/v3/roleplay-char-pyramid-client.png',
    cameraPosition: [0, 1.45, 2.5],
    cameraTarget: [0, 1.25, 0],
  ...
  'logic-tree-sub': {
    ...
    imageUrl: '/images/v3/roleplay-char-logic-tree-sub.png',
    cameraPosition: [0, 1.45, 2.5],
    cameraTarget: [0, 1.25, 0],
  ...
  'socrates-dialog': {
    ...
    imageUrl: '/images/v3/roleplay-char-socrates-dialog.png',
  ...
  'descartes-doubt': {
    ...
    imageUrl: '/images/v3/roleplay-char-descartes-doubt.png',
    cameraPosition: [0, 1.45, 2.4],
    cameraTarget: [0, 1.25, 0],
    rootRotation: [0, -0.1, 0],
    toneColor: '#d8d2f0',
  ...
  'nietzsche-values': {
    ...
    imageUrl: '/images/v3/roleplay-char-nietzsche-values.png',
    cameraPosition: [0, 1.45, 2.4],
    cameraTarget: [0, 1.25, 0],
    rootRotation: [0, 0.05, 0],
    toneColor: '#fcd5d2',
