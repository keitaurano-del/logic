...
const adhdLesson800: LessonData = {
  ...
  steps: [
    ...
    },
    {
      ...
      explanation:
        'The four traits commonly framed as ADHD strengths in this course are hyperfocus, divergent thinking, agility, and novelty seeking. "Perfectionist quality control" is a different cognitive profile (more often associated with autistic or obsessive-compulsive tendencies) and is not what this course means by an ADHD trait. They get mixed up easily, so it helps to separate them at the start.',
    },
  ],
}
...
const adhdLesson803: LessonData = {
  ...
  steps: [
    ...
    },
    {
      ...
      explanation:
        'The essence of easy-to-start is "concrete verb + visible duration + clear first action." "Finish perfectly" invites perfectionism mode and delays starting. "Three companies in parallel" is too large a chunk to start. "Pre-research and document organization, full set" is too abstract — the exact "where do I even start?" state ADHD brains hate most.',
    },
  ],
}
