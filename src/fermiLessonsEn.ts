...
const fermiLesson200: LessonData = {
  ...
  steps: [
    ...
    {
      type: 'explain',
      title: 'Margin of error, and the stance that you always produce an answer',
      content: 'For Fermi estimation, 1-2 orders of magnitude (10x to 100x) is enough precision.\n\n"How many cars are owned in Japan?"\n- Reference value (actual): about 78 million (MLIT vehicle registration data)\n- Acceptable Fermi range: somewhere between 10 million and 1 billion\n\nIn business decision-making, you usually only need to know "is this market on the order of ¥100M, ¥1B, or ¥10B?". The logical chain matters more than precision.\n\nThere is one important premise here: Fermi problems come in two distinct kinds. In both, you set premises and always produce a ballpark figure (an answer).\n\n1. Problems verifiable against measured data\n- Population, unit counts, market sizes — anything with official statistics or industry estimates\n- e.g. cars owned in Japan, convenience-store market size, number of households\n- After estimating, compare against the "reference value (actual)" and review where you drifted\n\n2. Problems hard to verify against measured data (still always produce a ballpark)\n- e.g. "hours humanity wastes waiting at traffic lights", "total annual happiness of Japan"\n- No verifiable official measured value exists, or the answer changes with your premises\n- Even so, we never stop at "this has no answer." We state our premises, produce a ballpark figure, and present it as the answer — valuing decomposition logic and order-of-magnitude sense over hitting the exact number\n\nIn this course, when measured data exists we show a "reference value (actual)"; when it does not, we still set premises and always produce a ballpark figure (a target).\n\n:::point\nReview on the axis of "was my decomposition logic sound?", not "did my number hit?" — but always produce an answer. Make it a habit.\n:::',
    },
    {
      type: 'quiz',
