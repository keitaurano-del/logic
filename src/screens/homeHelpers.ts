...
export const RANK_TIERS: RankTier[] = [
  ...
  },
  {
    ...
    descJa: '火山ガラスが急冷して生まれる漆黒の石。割った切り口は刃のように鋭く、古代では刀の素材にも使われた。',
    descEn: 'A jet-black stone forged from rapidly cooled volcanic glass. Its fractures are sharp as a blade — ancient peoples shaped it into weapons.',
    quoteJa: '「鋭利な刃物は静かに切る」',
    quoteEn: '"A sharp blade cuts in silence."',
  ...
  },
  {
    ...
    quoteJa: '「明鏡止水」',
    quoteEn: '"A clear mirror, still water."',
  ...
  },
  {
    ...
    descJa: '幾重もの縞模様を内に持つ石。長い年月をかけて少しずつ層を重ね、複雑な美しさを獲得した。',
    descEn: 'A banded stone whose stripes were laid down layer by layer over ages. Complexity earned through time.',
    quoteJa: '「継続は力なり」',
    quoteEn: '"Persistence is power."',
    tipJa: '一度学んだことを別の文脈で再利用せよ。重なる経験が、唯一の模様を作る。',
  ...
  },
  {
    ...
    quoteJa: '「温故知新」',
    quoteEn: '"Learn from the past, understand the present."',
  ...
  },
  {
    ...
    descJa: '貝が異物を包み続けて生み出す、唯一無二の球体。痛みを核に、長い時間をかけて美を結晶させる。',
