...
const CATEGORY_VISUAL: Record<string, CategoryVisual> = {
  'ロジカルシンキング': {
    ...
    image: `${IMG}/course-logic-01.webp`,
    routeKey: 'logic',
  },
  'クリティカルシンキング': {
  ...
  '論点設定': {
    ...
    iconBg: 'rgba(52,211,153,.14)',
    image: `${IMG}/course-issue-01.webp`,
  ...
  'なぜなぜ分析': {
    ...
    iconBg: 'rgba(52,211,153,.14)',
    image: `${IMG}/course-whywhy-01.webp`,
    routeKey: 'whywhy',
  },
  '提案・伝える技術': {
  ...
  '提案書作成': {
    ...
    image: `${IMG}/course-proposal-01.webp`,
    routeKey: '提案書作成',
  },
  '哲学・思考の原理': {
    ...
    image: `${IMG}/course-philosophy-01.webp`,
    routeKey: 'philosophy',
  },
  '東洋思想': {
    ...
    image: `${IMG}/course-eastern-01.webp`,
    routeKey: '東洋思想',
  },
  'クライアントワーク': {
    ...
    image: `${IMG}/course-client-01.webp`,
    routeKey: 'クライアントワーク',
  },
  'ケース面接': {
  ...
  '経営戦略': {
    ...
    image: `${IMG}/course-strategy-01.webp`,
    routeKey: '経営戦略',
  },
  'フェルミ推定': {
  ...
  '数値感覚': {
    ...
    iconBg: 'rgba(122,174,255,.14)',
    image: `${IMG}/course-numeracy-01.webp`,
    routeKey: 'numeracy',
  },
  'ピークパフォーマンス習慣': {
  ...
  '認知科学': {
    ...
    iconBg: 'rgba(167,139,250,.14)',
    image: `${IMG}/course-cognitive-01.webp`,
    routeKey: 'cognitive',
  },
  'ドキュメンテーション': {
    ...
    iconBg: 'rgba(96,165,250,.14)',
    image: `${IMG}/course-documentation-01.webp`,
  ...
  '構造化リスニング': {
    ...
    image: `${IMG}/course-listening-01.webp`,
    routeKey: '構造化リスニング',
  },
  'ロジカルライティング': {
    ...
    image: `${IMG}/course-logical-writing-01.webp`,
    routeKey: 'ロジカルライティング',
  },
  'ADHDレバレッジ': {
    ...
    image: `${IMG}/course-adhd-leverage-01.webp`,
    routeKey: 'ADHDレバレッジ',
  },
  '集中の技術': {
    ...
    image: `${IMG}/course-focus-now-01.webp`,
    routeKey: '集中の技術',
  },
  '体力デザイン': {
    ...
    iconBg: 'rgba(91,185,126,.14)',
    image: `${IMG}/course-peak-performance-01.webp`,
    routeKey: '体力デザイン',
  },
}
...
const PERSONAL_COURSE_CARD_COLLAPSED_KEY = 'logic-personal-course-card-collapsed'
...
function PersonalCourseBanner({
  ...
  const [collapsed, setCollapsed] = React.useState(
    () => localStorage.getItem(PERSONAL_COURSE_CARD_COLLAPSED_KEY) === '1'
  )
  ...
  const toggleCollapsed = (e: React.MouseEvent) => {
    ...
    localStorage.setItem(PERSONAL_COURSE_CARD_COLLAPSED_KEY, next ? '1' : '0')
    setCollapsed(next)
  }
  ...
  const cardStyle: React.CSSProperties = {
    ...
    borderRadius: 16,
    padding: collapsed ? '12px 16px' : '16px 18px',
    boxShadow: 'var(--shadow-v3-card-inset)',
    color: 'var(--accent-fg)',
    border: 'none',
    width: '100%',
