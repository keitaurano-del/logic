            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: showCorrect ? 'rgba(16,185,129,0.06)' : showWrong ? 'rgba(220,38,38,0.06)' : isSelected ? 'var(--brand-soft)' : 'var(--bg-card)',
                  color: showCorrect ? undefined : showWrong ? undefined : isSelected ? undefined : 'var(--text-primary)',
                }}
              >
                <span style={{
                  width: 26, height: 26,
