        ...
        <div id="home-fermi-card" style={{ position: 'relative', borderRadius: 'var(--radius-lg)', overflow: 'hidden', boxShadow: '0 12px 28px color-mix(in srgb, var(--accent) 24%, transparent)', flexShrink: 0 }}>
          ...
          >
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ background: 'var(--accent-btn-fg)', color: 'var(--accent-btn)', borderRadius: 'var(--radius-pill)', padding: '12px 18px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, fontSize: '0.9333rem', fontWeight: 700, boxShadow: '0 6px 18px rgba(0,0,0,.14)' }}>
                {allFermiDone ? (
                  <>
