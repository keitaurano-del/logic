      ...
      phases: [
        ...
        },
        {
          ...
          options: [
            ...
            { label: 'Build out Why-so? in 3 layers, in hypothesis form: ①New-customer drop ②Ad efficiency degraded (CPA +25%) ③Higher media costs + competitor bidding pressure', correct: true, feedback: 'Correct. Three layers minimum, each tagged "fact / hypothesis / unverified" gives visible depth. Push from the data on hand to structural causes (competitor bidding).' },
