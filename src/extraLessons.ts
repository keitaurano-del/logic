...
const criticalBias2: LessonData = {
  ...
  steps: [
    { type: 'explain', title: '確証バイアスとは何か', content: '人は自分の信念を支持する情報だけを集め、反証する情報を無視しやすい。これを確証バイアスという。[icon:bad] 支持する情報ばかり集める姿勢ではなく、[icon:good] 反証を探す姿勢に切り替えることが批判的思考の核心だ。\n\n:::point\n意識的に反証を探す習慣が、確証バイアスを破る決め手になります。\n:::' },
...
const criticalSunk: LessonData = {
  ...
  category: 'クリティカルシンキング',
  steps: [
    { type: 'explain', title: 'サンクコストとは', content: '過去に投入した時間・お金・労力（回収できないコスト）に引きずられて、合理的でない判断を続けてしまうバイアス。\n\n:::warn\n「もったいない」という感情が正しい判断を妨げます。取り戻せない過去ではなく、これからの価値で決めましょう。\n:::' },
...
const analogyMapping: LessonData = {
  ...
  category: 'アナロジー思考',
  steps: [
    { type: 'explain', title: '構造マッピングとは', content: 'アナロジーの核心は、表面的な類似ではなく構造的な類似を見つけること。[icon:bad] 見た目が似ている、ではなく、[icon:good] 仕組みが同じ、を狙う。「軍の補給システム」と「サプライチェーン管理」は分野は違っても同じ構造を持つ。構造を明示的にマッピングすることでアナロジーが使える。' },
